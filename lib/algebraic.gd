...
##  <Description>
##
##  Given a graph <A>G</A>, a group <A>Grp</A> and an action <A>Act</A> of <A>Grp</A> in some 
...
##  
##  If <A>Act</A> is omited, the standard &GAP; action <C>OnPoints</C> is used.
##
##  <Example>
...
##  <Description>
##
##  Returns the graph $G$ whose vertices are the elements of the group <A>Grp</A> 
...
##  <Description>
##
##  Returns the graph G whose vertices are the elements of the ring <A>Rng</A> 
...
##  <Description>
##
##  Returns the graph G whose vertices are the elements of <A>Rng</A> 
