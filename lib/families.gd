...
#V  EmptyGraph
##  
##  <#GAPDoc Label="EmptyGraph">
##  <ManSection>
##  <Var Name="EmptyGraph"/>
##  <Description>
##  
##  <P/>The graph on zero vertices and zero edges. The empty graph has 
##  conventional values for its attributes as shown in the examples. 
##  <Index Subkey="empty">graph</Index>
##   
##  <P/>
##  <Example>
##  gap> EmptyGraph;
...
##  0, Adjacencies := [  ] ) )
##  gap> Diameter(EmptyGraph);
##  0
##  gap> MaxDegree(EmptyGraph);
##  0
##  gap> MinDegree(EmptyGraph);
##  0
##  gap> Girth(EmptyGraph);
##  infinity
##  </Example>
##  
##  </Description>
##  </ManSection>
##  <#/GAPDoc>
DeclareGlobalVariable("EmptyGraph");
