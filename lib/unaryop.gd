##
##  <P/>some methods that operate on ONE graph
##
...
##  <Description>
##
##  <P/>Returns the quotient graph of graph <A>G</A> given a vertex partition
...
##  <Description>
##
##  <P/>Returns the cone of graph <A>G</A>. The cone of <A>G</A> is the graph 
...
##  <Description>
##
##  <P/>Returns the suspension of graph <A>G</A>. The suspension of <A>G</A> is the graph 
...
##  <Description>
##
##  <P/>Returns the pared graph of <A>G</A>. This is the induced subgraph obtained from 
...
##  <Description>
##
##  <P/>Returns the completely pared graph of <A>G</A>, which is obtained by repeatedly applying 
