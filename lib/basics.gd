...
##  <Description>
##
##  <P/>A global record where much &YAGS;-related information is stored. 
...
##  for advanced users.
##
##  <P/>However, storing user information in this record and/or changing the values of 
...
##  <Description>
##
##  <P/>Returns <C>true</C> if object <A>Obj</A> is <C>true</C> or <C>false</C> and <C>false</C> otherwise.
##
##  <Example>
...
##  <Description>
##
##  <P/>Dumps all information available for object <A>Obj</A>. This information
...
##  <P/>For internal use. 
##  
##  <P/>Declares a &YAGS; quantifiable property named <A>Name</A> for filter <A>Filter</A>. 
##  This in turns, declares a boolean &GAP; property <A>Name</A> and an integer &GAP; attribute <A>QtfyName</A>.  
##
##  <P/>The user must provide the method <A>Name</A>(<A>Obj</A>, <A>qtfy</A>). If <A>qtfy</A> is false,
...
##  <Description>
##  
##  <P/>For internal use. Implements the <A>find</A> operation on the <A>union-find structure</A>. 
##  
##  </Description>
##  </ManSection>
##  <#/GAPDoc>
...
##  <Description>
##  
##  <P/>For internal use. Implements the <A>unite</A> operation on the <A>union-find structure</A>. 
##  
##  </Description>
##  </ManSection>
##  <#/GAPDoc>
...
##  <Description>
##
##  <P/>Returns a copy of <A>Obj</A> with the order of its elements permuted randomly.
...
##  <Description>
##
##  <P/>Returns a random permutation of the list <C>[1, 2, ... <A>n</A>]</C>.
##
##  <Example>
...
##  <Description>
##
##  <P/>Returns a random subset of the set <A>Set</A>. When the positive integer <A>k</A> is provided, 
...
##  <Description>
##  
##  <P/>Returns a sublist of <A>L</A>, which is a complete list of representatives of 
