...
##  <Description>
##
##  <P/>Sets the coordinates of the vertices of <A>G</A>, which are used to draw <A>G</A>
##  by <C>Draw( <A>G</A> )</C>. 
##
##  <Example>
##  gap> g:=CycleGraph(4);;
...
##  <Description>
##
##  <P/>Gets the coordinates of the vertices of <A>G</A>, which are used to draw <A>G</A> 
...
##  <Description>
##
##  <P/>Converts a &YAGS; graph <A>G</A> into a raw format (number of vertices, coordinates and 
...
##  <Description>
##
##  <P/>Updates the coordinates of <A>G</A> from a file <A>FileName</A> in raw format. 
...
##  <Description>
##
##  <P/>Takes a graph <A>G</A> and makes a drawing of it in a separate window. 
