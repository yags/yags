...
##  <Description>
##
##  Returns the adjacency matrix of graph <A>G</A>.
##
##  <Example>
...
##  <Description>
##
##  Return the list of names of the vertices of <A>G</A>. The vertices of a graph in &YAGS; are always 
...
##  <Description>
##
##  Returns <C>true</C> if graph <A>G</A> have no loops, <C>false</C> otherwise. Loops are edges 
...
##  <Description>
##
##  Returns <C>true</C> if graph <A>G</A> is an undirected graph, <C>false</C> otherwise.
...
##  <Description>
##  
##  Returns <C>true</C> if graph <A>G</A> is an oriented graph, <C>false</C> otherwise.
...
##  <Description>
##
##  Returns <C>true</C> if graph <A>G</A> is a simple graph, <C>false</C> otherwise.
##  Regardless of the categories that <A>G</A> belongs to, <A>G</A> is simple if and only if 
##  <A>G</A> is undirected and loopless.
##
##  Returns <C>true</C> if the graph <A>G</A> is simple regardless of its category.
##
##  </Description>
##  </ManSection>
##  <#/GAPDoc>
...
##  <Description>
##
##  Returns the list [1..Order( <A>G</A> )].
##
##  <Example>
...
##  <Description>
##
##  Returns <C>true</C> if [<A>x</A>,<A>y</A>] is an edge of <A>G</A>.
##
##  <Example>
...
##  </Example>
##  
##  The first form, IsEdge(<A>G</A>, <A>x</A>, <A>y</A>), is a bit faster and hence more 
...
##  <Description>
##
##  Returns the adjacency list of vertex <A>x</A> in <A>G</A>.
##
##  <Example>
##  gap> g:=PathGraph(3);
##  Graph( Category := SimpleGraphs, Order := 3, Size := 2, Adjacencies := 
...
##  <Description>
##
##  Returns the adjacency lists of graph <A>G</A>.
##
##  <Example>
##  gap> g:=PathGraph(3);
##  Graph( Category := SimpleGraphs, Order := 3, Size := 2, Adjacencies := 
...
##  <Description>
##
##  Returns the list of edges of graph <A>G</A> in the case of <C>SimpleGraphs</C>.
##
##  <Example>
...
##  </Example>
##  
##  In the case of <C>UndirectedGraphs</C>, it also returns the loops. While in the 
...
##  <Description>
##
##  Returns a new graph created from the record <A>Rec</A>. The record must provide the field <A>Category</A> 
...
##  <Description>
##  
##  Returns a new graph created from an adjacency matrix <A>Mat</A>. The matrix <A>Mat</A> must
...
##  </Example>
##  
##  Note, however, that the graph is forced to comply with the <C>TargetGraphCategory</C>.
##  
##  <Example>
...
##  <Description>
##
##  Returns a new graph having <A>AdjList</A> as its list of adjacencies. The order of the created graph is 
...
##  <Description>
##
##  Returns the minimal graph where the elements of <A>Cover</A> are 
...
##  <Description>
##
##  Returns a new graph created from a set of vertices <A>V</A> and a binary relation <A>Rel</A>, 
...
##  </Example>
## 
##  Walks can be <A>nested</A>, which greatly improves the versatility of this function.
##   
##  <Example>
...
##  </Example>
##
##  Note that <C>GraphByWalks</C> has an even greater functionality.
##
##  </Description>
##  </ManSection>
##  <#/GAPDoc>
...
##  <Description>
##
##  Returns the intersection graph of the family of sets <A>L</A>. This graph has a 
...
##  <Description>
##
##  Returns a fresh copy of graph <A>G</A>. Only the order and adjacency information is copied, 
...
##  </Example>
##
##  The order of the elements in <A>V</A> does matter.
##
##  <Example>
...
##  <Description>
##
##  Returns a new graph created from graph <A>G</A> by adding as many new vertices 
...
##  <Description>
##
##  Returns a new graph created from graph <A>G</A> by adding the edges in list <A>E</A>.
##
##  <Example>
##  gap> g:=CycleGraph(4);   
##  Graph( Category := SimpleGraphs, Order := 4, Size := 4, Adjacencies := 
...
##  <Description>
##
##  Returns the connected components of <A>G</A>.
##
##  </Description>
##  </ManSection>
##  <#/GAPDoc>
...
##  <Description>
##
##  Returns the subgraph of <A>G</A> induced by the neighbors of <A>x</A>.
##
##  <Example>
...
##  
##  A vertex <A>x</A> is dominated by another vertex <A>y</A> when the closed neighborhood
...
##  
##  First let us consider the case where <A>Attribute</A> is a Boolean attribute 
...
##  
##  In the case of a non-Boolean attribute <C>GraphAttributeStatistics()</C> 
