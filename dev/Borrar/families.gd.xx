...
##  <Description>
##
##  Returns the discrete graph of order <A>n</A>. A discrete graph is a graph
##  without edges.
##
##  <Example>
##  gap> DiscreteGraph(4);
...
##  <Description>
##
##  Returns the complete graph of order <A>n</A>. A complete graph is a graph
...
##  <Description>
##
##  Returns the hypercube of dimension <A>n</A>. This is the box product (cartesian product) 
...
##  <Description>
##
##  Return the <A>n</A>-dimensional octahedron. This is the complement of <A>n</A> copies
...
##  <Description>
##
##  Returns the complete bipartite whose parts have order <A>n</A> and <A>m</A> respectively. 
...
##  <Description>
##
##  Returns a random graph of order <A>n</A> taking the rational $p\in [0,1]$ as the edge probability. 
##   
##  <Example>
...
##  </Example>
##   
##  If <A>p</A> is ommited, the edge probability is taken to be 1/2.
##
##  <Example>
##  gap> RandomGraph(5);    
##  Graph( Category := SimpleGraphs, Order := 5, Size := 5, Adjacencies := 
...
##  <Description>
##
##  Returns a cylinder of base <A>b</A> and height <A>h</A>. 
...
##  <Description>
##
##  In its first form <C>WheelGraph</C> returns the wheel graph on <A>n</A>+1 vertices. This is the 
...
##  </Example>
##
##  In its second form, <C>WheelGraph</C> returns returns the wheel graph, but adding 
...
##  <Description>
##   
##  Returns the <A>n</A>-Fan: The join of a vertex and a <A>(n+1)</A>-path.
##   
##  <Example>
##  gap> FanGraph(4);
...
##  <Description>
##
##  Returns the <A>n</A>-Sun: A complete graph on <A>n</A> vertices, $K_N$, with a corona 
...
##  <Description>
##   
##  The spiky graph is constructed as follows: Take complete graph on <A>n</A> vertices, $K_N$, 
...
##  </Example>
##   
##  When $n,m\geq 4$, <C>TorusGraph( <A>n</A>, <A>m</A> )</C> is actually a Whitney triangulation:
...
##  </Example>
##   
##  Note that in these cases, <C>TorusGraph( <A>n</A>, <A>m</A> )</C> is not 6-regular
...
##  <Description>
##   
##  Returns the clockwork graph <Cite Key="LN02"/><Cite Key="LNP04"/> specified by its parameters. 
...
##   
##  When <A>rank</A> and/or <A>Perm</A> are specified, they have the following effects:
...
##  <Description>
##   
##  The complement of a <C>ParapluieGraph</C>; The suspension of a 4-path with a 
