...
##  <Description>
##
##  Returns the line graph <A>L(G)</A> of graph <A>G</A>. The line graph is the
...
##  <Description>
##
##  Returns the new graph <A>H</A> such that  $V(H)=V(G)$ and 
##  $xy\in E(H) \iff xy \not\in E(G)$.
##
##  <Example> 
##  gap> g:=ClawGraph;
...
##  <Description>
##
##  Returns the quotient graph of graph <A>G</A> given a vertex partition
##  <A>Part</A>, by identifying any two vertices in the same part. 
##  The vertices of the quotient
##  graph are the parts in the partition <A>Part</A> two of them
##  being adjacent iff any vertex in one part is adjacent to any vertex in the other part.
##  Singletons may be omited in <A>Part</A>.
## 
##  <Example> 
##  gap> g:=PathGraph(8);; 
...
##  </Example>
##
##  In its second form, <C>QuotientGraph</C> identifies each vertex in list <A>L1</A>, 
##  with the corresponding vertex in list <A>L2</A>. <A>L1</A> and <A>L2</A> must have the same length,
...
##  <Description>
##
##  Returns the cone of graph <A>G</A>. The cone of <A>G</A> is the graph 
##  obtained from <A>G</A> by adding a new vertex which is adjacent to every 
##  vertex of <A>G</A>. The new vertex is the first one in the new graph.
##
##  <Example> 
...
##  <Description>
##
##  Returns the suspension of graph <A>G</A>. The suspension of <A>G</A> is the graph 
##  obtained from <A>G</A> by adding two new vertices which are adjacent to every 
##  vertex of <A>G</A> but not to each other. The new vertices are the first ones 
##  in the new graph.
##
##  <Example> 
...
##  <Description>
##
##  Returns the pared graph of <A>G</A>. This is the induced subgraph obtained from 
##  <A>G</A> by removing its dominated vertices. When there are twin vertices 
...
##  <Description>
##
##  Returns the completely pared graph of <A>G</A>, which is obtained by repeatedly applying 
##  <C>ParedGraph</C> until no more dominated vertices remain. 
##
##  <Example>
##  gap> g:=PathGraph(6);
