...
##  <Description>
##  
##  Returns <C>true</C> if <A>G</A> is a tournament.
##  
##  <Example>
##  gap> tt:=CompleteGraph(5:GraphCategory:=OrientedGraphs);
##  Graph( Category := OrientedGraphs, Order := 5, Size := 10, Adjacencies := 
...
##  <Description>
##  
##  Returns <C>true</C> if <A>G</A> is a transitive tournament.
##  
##  <Example>
##  gap> tt:=CompleteGraph(5:GraphCategory:=OrientedGraphs);
##  Graph( Category := OrientedGraphs, Order := 5, Size := 10, Adjacencies := 
...
##  </Example>
##  
##  Note that <C>PaleyTournament( <A>prime</A> )</C> returns a graph in the 
...
##  </Example>
##  
##  Note that <C>Orientations( <A>G</A> )</C> returns a list of graphs, each of them in the 
##  category <C>OrientedGraphs</C> regardless of the <C>TargetGraphCategory</C>.  
##  
##  </Description>
##  </ManSection>
